...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/shuaichao171/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="shuaichao171/sub2api"
...
Documentation=https://github.com/shuaichao171/sub2api
