...
const GITHUB_REPO = 'shuaichao171/sub2api'
// GHCR image published by fork CI (tags carry no "v" prefix, e.g. ghcr.io/shuaichao171/sub2api:0.2.6)
const DOCKER_IMAGE = 'ghcr.io/shuaichao171/sub2api'
